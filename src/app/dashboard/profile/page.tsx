...
export default function Page() {
    return (
        <main className="flex-1 bg-green-400 px-10 py-6">
            <h1>Profile Page</h1>
            <div className="grid bg-green-200 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                {categories.map((c, i) => (
