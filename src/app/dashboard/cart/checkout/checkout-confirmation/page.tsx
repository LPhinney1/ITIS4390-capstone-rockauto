            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                            ...
                            {orderData.items.map((item: any) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-500">
                                            Part #:{' '}
                                            {String(item.Product.id).padStart(
                                                6,
                                                '0',
                                            )}
                                        </p>
                    ...
                    <div className="rounded-2xl bg-white p-6 shadow-sm">
                        ...
                        <button className="mt-6 flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 py-3 text-gray-700 transition-colors hover:bg-gray-50">
                        ...
                        <button
                            onClick={() => router.push('/')}
                            className="mt-3 w-full rounded-lg bg-indigo-500 py-3 font-semibold text-white transition-colors hover:bg-indigo-600"
                        >
                            Continue Shopping
                        </button>
                    </div>
                ...
                <div className="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
                    ...
                    <button className="rounded-lg bg-indigo-500 px-6 py-2 font-semibold text-white transition-colors hover:bg-indigo-600">
                        Contact Support
                    </button>
                </div>
            </div>
