...
export default function AddToCartButton({
    ...
    return (
        <button
            ...
            className={clsx(
                'flex h-7 w-7 items-center justify-center rounded-full text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2',
                disabled
