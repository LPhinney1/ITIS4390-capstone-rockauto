...
export function ProductCardHome({ product, onAdd }: ProductCardProps) {
  return (
    <div
      className={` rounded-lg w-[300px] h-[240px] overflow-hidden shadow-sm hover:shadow-lg border border-gray-200 transition-all ${product.outOfStock ? 'opacity-70 cursor-default' : 'cursor-pointer'
        } group`} >
