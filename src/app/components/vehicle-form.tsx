...
export default function VehicleForm({
    ...
    return (
        <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6 shadow-md">
            <h2 className="mb-6 text-[24px] text-gray-900">
                {initial?.id ? 'Edit Vehicle' : 'Add New Vehicle'}
            </h2>
                ...
                <div className="mb-6 grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-[#6366f1] focus:outline-none"
                            required
                        >
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                handleChange('engine', e.target.value)
                            }
                            className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-[#6366f1] focus:outline-none"
                            required
                        >
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <button
                            ...
                            className="rounded-lg border border-gray-300 bg-gray-50 px-4 py-2 text-sm transition-colors hover:bg-gray-100"
                        >
                            Use Test Data
                        </button>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            type="submit"
                            className="rounded-lg bg-[#5b5fc7] px-6 py-2 text-white transition-colors hover:bg-[#4f46e5]"
                        >
